...
namespace ASceneTest
{
    public class RoleGameRunTest : MonoBehaviour
    {
        ...
        //         yield return _contentRoot.Init(content.sizeDelta, "ai", JObject.Parse(textAsset.text), true);
        //     }
        //     else
        //     {
        //         yield return CharacterContentRoot.CreateRole<CharacterContentRoot>(content.sizeDelta,
        //             transform,
        //             "ai",
        ...
        //
        //     var player = (name: "player", value: User.UserName);
        //
