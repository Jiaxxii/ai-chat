...
namespace Xiyu.ArtificialIntelligence
{
    /// <summary>
    ...
    public class Multimap<TKey, TValue> : IDictionary<TKey, IList<TValue>>
    {
        ...
        public void Add(TKey key, IList<TValue> value)
        {
            ...
            {
                throw new AggregateException($"重复的key\"{nameof(key)}\"");
            }
        }
        ...
        /// 尝试添加一项。
        /// </summary>
        /// <param name="key">要用作要添加的项的键的对象。</param>
        /// <param name="value">要用作要添加的项的值的对象。</param>
        /// <returns></returns>
        public bool TryAdd(TKey key, IList<TValue> value)
        {
            if (_dictionary == null)
            {
                throw new NullReferenceException();
        ...
        /// <summary>
        /// 尝试在Value[list]中添加不重复的一项。
        /// </summary>
        /// <param name="key">要用作要添加的项的键的对象。</param>
        /// <param name="value">要用作要添加的项的值的对象。</param>
        /// <returns></returns>
        [Obsolete("建议手动实现，而不是调该方法")]
        ...
        /// <summary>
        /// 添加一项，如果存在则覆盖新值，如果不存在则添加
        /// </summary>
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void OverAdd(TKey key, IList<TValue> value)
        {
            if (_dictionary == null)
            {
                throw new NullReferenceException();
